...
```bash
clone-gd-addon https://github.com/ChillCube/Rotator2D.git
```

## Documentation
You can find the documentation at: https://github.com/ChillCube/Rotator2D/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon Rotator2D
```
